...
# Note: this site has issues clearing the screen and formatting the text (so some words get cut off for no reason), so we highly recommend running the code on the Visual Studio Code app instead

import sys           # import these for a randomizer or clear screen, etc.
import os
import math
import random
...
def rockpaperscissors():    # define a function for the rock paper scissors game
    os.system('cls')        # the computer picks a random selection and the player will be asked to input their selection
